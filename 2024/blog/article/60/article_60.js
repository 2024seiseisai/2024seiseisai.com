$(document).ready(function() {
    ...
    var articles = [
        ...
        { href: '../05/05.html', img: '../catch_img/05.webp', date: '2024.08.22', title: '復活した書道パフォーマンス‼︎', author: 'PRパート員 Y.T. & H.A.' },
        ...
        { href: '../09/09.html', img: '../catch_img/09.webp', date: '2024.08.22', title: '全国強豪のクイズ研究部、文化祭での見どころ！', author: 'PRパート員 M.K.' },
        { href: '../10/10.html', img: '../catch_img/10.webp', date: '2024.08.22', title: '文化祭の裏側、会計パートの仕事に迫る', author: 'PRパート員U.Y. & N.R. & Y.A.' },
        { href: '../11/11.html', img: '../catch_img/11.webp', date: '2024.08.22', title: 'お化け屋敷の裏側を暴く', author: 'PRパート員 K.K. & Y.U.' },
