...
var hamburger_animation_PC = lottie.loadAnimation({
    ...
    loop: false,
    autoplay: false,
    path: "static/header_img/hamburger.json" // JSONファイルのパス
});
...
$("#menu_SNS_item_X").hover(function(){
    $("#menu_SNS_item_X_img").fadeTo(50,0,function(){
        $("#menu_SNS_item_X_img").attr("src","static/header_img/twitter_white.svg");
        $("#menu_SNS_item_X_img").fadeTo(50,1);
    });
},function(){
    $("#menu_SNS_item_X_img").fadeTo(50,0,function(){
        $("#menu_SNS_item_X_img").attr("src","static/header_img/X_white.svg")
        $("#menu_SNS_item_X_img").fadeTo(50,1);
    });
});
